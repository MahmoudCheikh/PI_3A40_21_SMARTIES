 ...
 */
final class Version20220216152155 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD prix INT NOT NULL, ADD type VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE users CHANGE id_user id_user VARCHAR(255) NOT NULL, CHANGE image image VARCHAR(255) NOT NULL, CHANGE role role VARCHAR(255) NOT NULL');
    }
